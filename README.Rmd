...
Structure of the research compendium of the [practice 2](https://rdatatoolbox.github.io/ex-rmarkdown.html) of the training course 
...
main R script to run the entire project by rendering the [`index.Rmd`](https://github.com/rdatatoolbox/practice2/tree/main/index.Rmd)
...
The final result is [`index.html`](https://github.com/rdatatoolbox/practice2/tree/main/index.html) and it is
available online [here](https://rdatatoolbox.github.io/practice2).
